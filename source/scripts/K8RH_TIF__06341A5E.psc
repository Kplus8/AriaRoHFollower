...
Scriptname K8RH_TIF__06341A5E Extends TopicInfo Hidden
...
arPortal = akSpeakerRef.PlaceAtMe(game.GetFormFromFile(511317, "Skyrim.ESM"), 1, false, false)
akSpeakerRef.Disable(false)
;END CODE
EndFunction
;END FRAGMENT
