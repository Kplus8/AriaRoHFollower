...
;BEGIN ALIAS PROPERTY RememberHyrule
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_RememberHyrule Auto
;END ALIAS PROPERTY
...
;BEGIN ALIAS PROPERTY RoyalBroadsword
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_RoyalBroadsword Auto
;END ALIAS PROPERTY
...
K8RHAriaLbtWRememberOutside.Start()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
;Sheikiah Armor
K8RHAriaLbtWSheikahArmor.Start()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
;Royal Broadsword
K8RHAriaLbtWRoyalBroadsword.Start()
;END CODE
EndFunction
;END FRAGMENT
...
Scene Property K8RHAriaLbtWRememberOutside  Auto  

Scene Property K8RHAriaLbtWSeeThey  Auto  

Scene Property K8RHAriaLbtWEnterShadow  Auto  

Scene Property K8RHAriaLbtWRoyalBroadsword  Auto  

Scene Property K8RHAriaLbtWCaptainHat  Auto  

Scene Property K8RHAriaLbtWSheikahArmor  Auto
